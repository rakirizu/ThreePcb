        ...
        expect(results).to.eql([
            {
                ...
                polarity: Parser.DARK,
                width: 2,
                segments: [{ type: Tree.PLOT_LINE, start: [1, 2], end: [3, 4] }],
            },
        ])
    })
    ...
    it('should plot linear drill routes', () => {
        ...
        expect(results).to.eql([
            ...
            },
            {
                ...
                polarity: Parser.DARK,
                width: 2,
                segments: [{ type: Tree.PLOT_LINE, start: [5, 6], end: [7, 8] }],
                dcode: '1',
            },
        ])
    })
        ...
        expect(results).toEqual([
            {
                ...
                segments: [
                    {
                        type: Tree.ARC,
                        start: [1, 0, expect.assertions(0)],
                        end: [halfSqrtTwo, halfSqrtTwo, PI / 4],
                        center: [expect.assertions(0), expect.assertions(0)],
                        radius: 1,
                    },
                ],
            },
    ...
    it('should transition from route mode back to drill mode', () => {
        ...
        expect(results).to.eql([
            ...
            },
            {
                ...
                polarity: Parser.DARK,
                dcode: '1',
                shape: { type: Tree.PLOT_CIRCLE, cx: 7, cy: 8, r: 1 },
            },
        ])
    })
})
