...
describe('plot stroke paths', () => {
  ...
  it('should plot a region', () => {
    const results = subject(
      ...
      [{ type: Parser.GRAPHIC, graphic: Parser.SEGMENT, coordinates: {} }, undefined, location1],
      [{ type: Parser.GRAPHIC, graphic: Parser.SEGMENT, coordinates: {} }, undefined, location2],
      [{ type: Parser.GRAPHIC, graphic: Parser.SEGMENT, coordinates: {} }, undefined, location3],
      [{ type: Parser.DONE }]
    )
  ...
  it('should plot a region in between plotting paths', () => {
    ...
    const results = subject(
      [{ type: Parser.GRAPHIC, graphic: Parser.SEGMENT, coordinates: {} }, tool, location0],
      [{ type: Parser.REGION_MODE, region: true }],
      ...
      [{ type: Parser.GRAPHIC, graphic: Parser.SEGMENT, coordinates: {} }, tool, location3],
      [{ type: Parser.REGION_MODE, region: false }],
      [{ type: Parser.GRAPHIC, graphic: Parser.SEGMENT, coordinates: {} }, tool, location4],
      [{ type: Parser.DONE }]
    )
