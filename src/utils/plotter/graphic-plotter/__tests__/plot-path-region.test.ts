        ...
        expect(results).to.eql([
            {
                ...
                dcode: undefined,
                segments: [
                    { type: Tree.PLOT_LINE, start: [0, 0], end: [1, 0] },
                    { type: Tree.PLOT_LINE, start: [1, 0], end: [1, 1] },
                    { type: Tree.PLOT_LINE, start: [1, 1], end: [0, 0] },
                ],
            },
        ])
    })
        ...
        expect(results).to.eql([
            {
                ...
                width: 2,
                dcode: '1',
                segments: [{ type: Tree.PLOT_LINE, start: [-10, -10], end: [-5, -5] }],
            },
            {
                type: Tree.IMAGE_REGION,
                polarity: Parser.DARK,
            ...
            },
            {
                ...
                width: 2,
                dcode: '1',
                segments: [{ type: Tree.PLOT_LINE, start: [5, 5], end: [10, 10] }],
            },
        ])
    })
