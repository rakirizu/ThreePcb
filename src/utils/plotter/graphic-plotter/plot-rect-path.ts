...
import type { Rectangle } from '../../parser'

import { HALF_PI, PI, positionsEqual } from '../coordinate-math'
import * as Tree from '../tree'

// Rectangular tools make interesting stroke geometry; see the Gerber spec
// for graphics and examples
export function plotRectPath(segments: Tree.PathSegment[], shape: Rectangle): Tree.ImageShape {
...
function plotRectPathSegment(segment: Tree.PathLineSegment, shape: Rectangle): Tree.PolygonShape {
