...
describe('bounding box calculations', () => {
    ...
    it('should create from a circle graphic', () => {
        const result = subject.fromGraphic({
            ...
            shape: { type: Tree.PLOT_CIRCLE, cx: 1, cy: 2, r: 3 },
        })
    ...
    it('should create from a rectangle graphic', () => {
        const result = subject.fromGraphic({
            type: Tree.IMAGE_SHAPE,
            shape: { type: Tree.PLOT_RECTANGLE, x: 1, y: 2, xSize: 3, ySize: 4 },
        })
    ...
    it('should create from an outline graphic', () => {
        const result = subject.fromGraphic({
            ...
            shape: {
                type: Tree.OUTLINE,
                segments: [
                    { type: Tree.PLOT_LINE, start: [9, 8], end: [7, 6] },
                    { type: Tree.PLOT_LINE, start: [1, 2], end: [3, 4] },
                ],
            },
        })
    ...
    it('should create from a layered shape graphic', () => {
        const result = subject.fromGraphic({
            ...
            shape: {
                ...
                shapes: [
                    { type: Tree.PLOT_RECTANGLE, x: 1, y: 2, xSize: 3, ySize: 4 },
                    { type: Tree.PLOT_CIRCLE, cx: 1, cy: 2, r: 3 },
                ],
            },
        })
    ...
    it('should ignore erase items in a layered shape graphic', () => {
        const result = subject.fromGraphic({
            ...
            shape: {
                type: Tree.LAYERED_SHAPE,
                shapes: [
                    { type: Tree.PLOT_RECTANGLE, x: 1, y: 2, xSize: 3, ySize: 4, erase: false },
                    { type: Tree.PLOT_CIRCLE, cx: 1, cy: 2, r: 3, erase: true },
                ],
            },
        })
    ...
    describe('paths and outlines', () => {
        ...
        it('should handle an arc through the positive Y-axis', () => {
            ...
            const radius = 1
            const expected = [-halfSqrtTwo - 0.5, halfSqrtTwo - 0.5, halfSqrtTwo + 0.5, 1.5]
        ...
        it('should handle a CCW arc through the negative X-axis', () => {
            ...
            const center: Tree.Position = [0, 0]
            const radius = 1
            const expected = [-1.5, -halfSqrtTwo - 0.5, -halfSqrtTwo + 0.5, halfSqrtTwo + 0.5]
        ...
        it('should handle an arc through the negative Y-axis', () => {
            ...
            const center: Tree.Position = [0, 0]
            const radius = 1
            const expected = [-halfSqrtTwo - 0.5, -1.5, halfSqrtTwo + 0.5, -halfSqrtTwo + 0.5]
        ...
        it('should handle an arc through the positive X-axis', () => {
            ...
            const center: Tree.Position = [0, 0]
            const radius = 1
            const expected = [halfSqrtTwo - 0.5, -halfSqrtTwo - 0.5, 1.5, halfSqrtTwo + 0.5]
        ...
        it('should get the size of a region', () => {
            const result = subject.fromGraphic({
                ...
                segments: [{ type: Tree.PLOT_LINE, start: [3, 2], end: [1, 0] }],
            })
